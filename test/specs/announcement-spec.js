describe('A guest clicks on announcement to see more info', function(){
	...
	describe('announcement widget', function(){
		
		var _announcement;
		
		beforeEach(function(){
			_announcement = $("<section>").data("widget", "announcement");
		});
	...
	describe('announcements widget', function(){
		
		var _announcements;
		
		beforeEach(function(){
			_announcements = $("<section>").data("widget", "announcements");
		});
	});
